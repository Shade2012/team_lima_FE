...
class MockAuthNotifier extends AuthNotifier {
  ...
  Future<bool> updateProfile({String? username, String? email}) async {
    if (username == null || email == null || username.isEmpty || email.isEmpty) return false;
...
void main() {
  group('CustomerProfilePage Actions Widget Tests', () {
    testWidgets('Happy Path: CustomerProfilePage renders profile header with initials avatar and options', (tester) async {
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            ...
            customerTicketsProvider.overrideWith(() => MockCustomerTicketsNotifier()),
          ],
    ...
    testWidgets('Happy Path: Tapping Edit Profile opens edit sheet and updates user info', (tester) async {
      tester.view.physicalSize = const Size(800, 1400);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(() => tester.view.resetPhysicalSize());
      ...
      // Enter new username
      await tester.enterText(find.widgetWithText(TextField, 'Username'), 'Alex Rivera');
    ...
    testWidgets('Unhappy Path: Tapping Logout shows confirmation dialog', (tester) async {
      tester.view.physicalSize = const Size(800, 1400);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(() => tester.view.resetPhysicalSize());
      ...
      expect(find.text('Are you sure you want to logout from VELOCE?'), findsOneWidget);
