...
void main() {
  ...
  group('LoginPage Widget Tests', () {
    testWidgets('Happy Path: Should render all essential UI components on LoginPage', (WidgetTester tester) async {
    ...
    testWidgets('Happy Path: Should allow typing email and password into text fields', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetUnderTest());
      await tester.pumpAndSettle();
    ...
    testWidgets('Unhappy Path: Tap Sign In with empty fields displays error snackbar', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetUnderTest());
      await tester.pumpAndSettle();
