...
void main() {
  ...
  group('SignupPage Widget Tests', () {
    testWidgets('Happy Path: Should render all essential UI components and role selector', (WidgetTester tester) async {
      ...
      expect(find.byType(TextField), findsNWidgets(4)); // Username, Email, Password, ConfirmPassword
      expect(find.text('Create Account'), findsOneWidget);
    });

    testWidgets('Happy Path: Should toggle role between Customer and Event Organizer', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetUnderTest());
      await tester.pumpAndSettle();
    ...
    testWidgets('Unhappy Path: Tap Create Account with empty fields triggers validation snackbar', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetUnderTest());
      await tester.pumpAndSettle();
