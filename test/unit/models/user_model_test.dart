...
void main() {
  group('UserModel Unit Tests', () {
    test(
      'Happy Path: Should correctly parse full JSON response from backend DTO',
      () {
        final jsonMap = {
        ...
        expect(
          user.createdAt,
          equals(DateTime.parse("2026-08-12T10:00:00.000Z")),
        );
        expect(
          user.updatedAt,
          equals(DateTime.parse("2026-08-12T10:00:00.000Z")),
    ...
    test(
      'Unhappy Path: Should handle empty or missing JSON fields gracefully without crashing',
      () {
