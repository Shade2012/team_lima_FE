...
void main() {
  group('Auth Requests Unit Tests', () {
    test('Happy Path: LoginRequest.toJson produces correct backend payload', () {
    ...
    test('Happy Path: RegisterRequest.toJson for GATE_OPERATOR role with eventId', () {
      final request = RegisterRequest(
    ...
    test('Unhappy Path: RegisterRequest.toJson omits empty or null eventId', () {
      final request = RegisterRequest(
        username: 'john_doe',
        email: 'john@example.com',
        password: 'Password123!',
