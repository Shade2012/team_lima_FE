...
void main() {
  group('CustomerRefundModel Unit Tests', () {
    test(
      'Happy Path: Should parse CustomerRefundModel from nested JSON correctly',
      () {
        final json = {
          'id': 'ref-001',
          'ticketId': 'tkt-001',
          ...
          'ticket': {
            'category': {
              'name': 'VIP Pass',
              'event': {'name': 'Sonic Resonance Festival'},
            },
            'seat': {'seatCode': 'A-1'},
          },
        };
    ...
    test(
      'Happy Path: Should parse fallback fields when nested objects are absent',
      () {
        final json = {
          'id': 'ref-002',
          'ticketId': 'tkt-002',
