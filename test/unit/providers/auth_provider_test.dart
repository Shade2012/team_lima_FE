...
void main() {
  group('AuthNotifier Unit Tests', () {
    ...
    test('Happy Path: AuthNotifier should initialize with default AuthState', () {
    ...
    test('Happy Path: AuthNotifier state update methods (setEmail, setPassword, setRole)', () {
    ...
    test('Unhappy Path: login fails validation when email or password is empty', () async {
      final notifier = container.read(authProvider.notifier);
    ...
    test('Unhappy Path: register fails validation when passwords do not match', () async {
      final notifier = container.read(authProvider.notifier);
