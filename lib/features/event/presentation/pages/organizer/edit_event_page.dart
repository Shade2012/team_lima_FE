...
class _EditEventPageState extends ConsumerState<EditEventPage> {
  ...
  void initState() {
    ...
    _refundPercentageController = TextEditingController(
      text: widget.refundPercentage != null
          ? widget.refundPercentage.toString()
          : '',
    );
  ...
  Widget build(BuildContext context) {
    final updateState = ref.watch(updateEventProvider);
  ...
  Widget _buildSubmitButton(UpdateEventState state) {
    return SizedBox(
